...
public interface CommentsDAO {
	...
	public List<CommentVO> selectByBoardNo(@Param(value = "boardNo")int no, @Param(value = "page") Page page,@Param(value = "myComment")int myComment);
	public List<CommentVO> selectReComment(@Param(value = "no")int no, @Param(value = "page")Page page,@Param(value = "myComment")int myComment);
