...
public class CommentService {
	...
	public List<CommentVO> selectComment(int boardNo, Page page){ return commentDAO.selectComment(boardNo, page.initTotal(commentDAO.selectCommentCount(boardNo))); }
