...
<div class="container">
   <div class="title">
      <h1>고객센터</h1>
   <ul class="tabs">
      <a href="/board/boardList?kind=8"><li class="tab-link current" data-tab="tab-1">1:1문의</li></a>
      <a href="/board/boardList?kind=9"><li class="tab-link" data-tab="tab-2">자주묻는 질문</li></a>
   </ul>
   </div>
