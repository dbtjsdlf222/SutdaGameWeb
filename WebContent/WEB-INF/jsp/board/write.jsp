...
<jsp:include page="../include/header.jsp" flush="false" />
	...
	<script>
		...
		$('form').submit(function(e){
			if($inputTitle.val()trim().length < 2 || $inputTitle.val().trim().length > 15){ alert("제목은 2자에서 15자여야 합니다."); return false; }
			if($inputContent.val()trim().length < 2){ alert("내용은 2글자 이상이여야 합니다."); return false; }
