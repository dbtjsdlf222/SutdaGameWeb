...
<div class="container">
	<div class="title">
		<h1>커뮤니티</h1>
	<ul class="tabs">
		<a href="/board/boardList?kind=5"><li class="tab-link current" data-tab="tab-1">자유게시판</li></a>
		<a href="/board/boardList?kind=6"><li class="tab-linkl" data-tab="tab-2">스크린샷 게시판</li></a>
	</ul>
	</div>
