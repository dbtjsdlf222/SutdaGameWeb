    ...
    <div class="tab">
        <div class="tab-content">
            <div id="user" data-tab-content class="active">
                ...
                <table id="tab">
               	 	<tr>
	               	 	<td class="pass_td">비밀번호</td>
	               	 	<td>
					        <input type="password" id="change_pw" name="password" required placeholder="비밀번호 입력(8~14자)" minlength="8" maxlength="14"><p id="pwMsg">　</p>
	           	 		</td>
           	 		</tr>
           	 		<tr>
                    	<td class="pass_td">비밀번호 확인</td>
                    	<td><input type="password" id="change_pwc"  required placeholder="비밀번호 확인"> <p id="pwcMsg">　</p></td>
                   	</tr>
                    <tr>
                    	<td colspan="2">
                    		<span class="login-sub"><input type="submit" value="비밀번호 변경"></span>	
	                    </td>
                    </tr>
                </table>
